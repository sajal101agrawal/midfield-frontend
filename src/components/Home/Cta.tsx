  ...
  return (
    <>
      ...
      <section className="container mx-auto text-center py-6 mb-12">
        <h2 className="w-full my-2 lg:text-5xl text-4xl font-bold leading-tight text-center text-white">
          Start Now
        </h2>
        <div className="w-full mb-4">
          <div className="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <h3 className="my-4 lg:text-3xl text-meta-9 text-2xl leading-tight p-4 pt-0">
