    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-4 lg:py-6.5">
        <NavLink to="/dashboard">
          <img src={midfieldLogo} alt="Logo" className="h-18" />
        </NavLink>
      ...
      <div className="no-scrollbar h-full flex flex-col justify-between overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        ...
        <div className="px-4 py-4 lg:px-6">
          <button
            className="px-4 flex items-center gap-2.5 rounded-sm py-2 w-full font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
            onClick={() => logOut()}
          >
            <svg
              className="fill-current"
